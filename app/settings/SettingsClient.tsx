    ...
    <motion.div key="general" {...tabAnim} className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex w-full sm:w-auto items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-xl transition-all hover:shadow-md disabled:opacity-60 text-sm ml-auto"
          style={{ fontFamily: "var(--font-fredoka)" }}
        >
          {saving ? (
        ...
        <div className="space-y-5">
          <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
              ...
              <span className="self-start flex items-center gap-1 text-xs font-bold text-green-700 bg-green-50 border border-green-200 px-3 py-1.5 rounded-full whitespace-nowrap">
  ...
  return (
    <motion.div key="billing" {...tabAnim} className="space-y-6">
      <SectionCard>
        ...
        {/* Plan badge */}
        <div className="flex items-center justify-between gap-3 p-4 sm:p-5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border-2 border-green-200 mb-5">
          <div>
    ...
    >
      ...
      <header className="bg-white border-b border-green-100 shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden sm:flex h-9 w-9 rounded-xl bg-gray-100 hover:bg-gray-200 items-center justify-center transition-colors">
              <Bell className="h-4 w-4 text-gray-500" />
            </button>
            <div className="flex items-center gap-2 sm:pl-2 sm:border-l border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 pb-24 lg:py-8 lg:pb-8">
        <div className="flex gap-8 items-start">
          ...
          <main className="flex-1 min-w-0">
            {/* Mobile bottom nav — rendered in DOM here, visually fixed at bottom */}
                ...
                {TABS.map(({ id, label, emoji }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[9px] font-bold leading-none ${isActive ? "text-green-600" : "text-gray-400"}`}>
                        {label}
                      </span>
                    </button>
                  );
