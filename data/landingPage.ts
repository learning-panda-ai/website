export const problems = [
  {
    before:
      "Generic AI gives answers from any syllabus — often wrong for Indian boards",
    after:
      "Panda answers directly from your CBSE or ICSE textbook — chapter by chapter",
  },
  {
    before:
      "Private tutors cost ₹500–₹2,000 per hour and aren't always available",
    after: "Panda is available 24/7 for a fraction of the cost — at ₹299/month",
  },
  {
    before:
      "Students forget what they studied weeks ago with no system to revise",
    after:
      "Panda uses spaced repetition to resurface concepts before they're forgotten",
  },
];
...
export const testimonials = [
  {
    quote:
      "My daughter used to call me at midnight with Maths doubts. Now she just asks Panda and gets the exact CBSE explanation she needs, in Hindi. I can finally sleep.",
    name: "Sunita Verma",
  ...
  {
    quote:
      "The quiz battles are addictive. I challenged my friend to a Chemistry chapter battle and ended up revising the whole periodic table without even realising it.",
    name: "Arjun Patel",
  ...
  {
    quote:
      "As a teacher, the at-risk alerts are genuinely useful. I caught two students falling behind three weeks before the unit test — and we fixed it in time.",
    name: "Meera Nambiar",
